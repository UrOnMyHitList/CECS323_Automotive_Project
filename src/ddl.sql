...
CREATE TABLE SERVICEVISIT(
    ...
    PRIMARY KEY(CUSTOMERID,EMPLOYEEID,SDATE),
    FOREIGN KEY(CUSTOMERID) REFERENCES CUSTOMER(CUSTOMERID),
...
CREATE TABLE SERVICEINSTANCE (
    ...
    PRIMARY KEY(CUSTOMERID,SERVICETECHID,SDATE,SERVICECODE),
    FOREIGN KEY(CUSTOMERID, SERVICETECHID, SDATE) REFERENCES SERVICEVISIT(CUSTOMERID, EMPLOYEEID, SDATE),
